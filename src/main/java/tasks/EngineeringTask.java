...
public class EngineeringTask extends ColonyTask {
	...
	public EngineeringTask(String name, int powerUnitsRequired, int requiredParts, int crewMembersRequired,
	...
	public String getResourceSummary() {
		return "Power:" + powerUnitsRequired + " Parts:" + requiredParts + " Crew:" + crewMembersRequired;
	}

	@Override
	public boolean hasEnoughResources(ResourceManager rm) {
		return super.hasEnoughResources(rm) && rm.hasEnough(Resource.POWER_UNITS, powerUnitsRequired);
	}
