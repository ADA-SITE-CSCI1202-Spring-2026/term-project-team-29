...
public class LifeSupportTask extends ColonyTask {
	...
	public LifeSupportTask(String name, int oxygenRequired, int spaceSuits, int requiredParts, int crewMembersRequired,
	...
	public String getResourceSummary() {
		return "O2:" + oxygenRequired + " Suits:" + spaceSuits + " Parts:" + requiredParts + " Crew:"
				+ crewMembersRequired;
	}

	@Override
	public boolean hasEnoughResources(ResourceManager rm) {
		return super.hasEnoughResources(rm) && rm.hasEnough(Resource.OXYGEN, oxygenRequired)
